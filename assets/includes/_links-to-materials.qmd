...
instr_names <- c("Andrew", "Iain", "Silas", "Shobhana", "Jeremy")
instr_quartopub <- c("andrew", "iainc", "silas", "shobhana", "sanchez")
...
##== Worksheets ==##
# TODO scope this more narrowly to only pick up non-problem set worksheets
# or just add them as ignores on on the assignment page?
