...
- Problem set: Introduction to chance
...
:::{.notes}
We can do the same thing with coin tosses and in fact, this justifies our earlier, intuitive understanding of what happens when we toss a fair coin.
Can also go over code to make sure they understand `sample()`
:::
...
You can talk about why we use set.seed().
:::
