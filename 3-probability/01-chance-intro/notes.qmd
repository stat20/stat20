...
[^Backus]: <https://www.astro.sunysb.edu/fwalter/AST248/why_i_dont_have_a_girlfriend.pdf>
...
In 17th century France, gamblers would bet on anything. In particular, they would bet on a die landing 6 at least once in four rolls of a six-sided fair die. Antoine Gombaud, called the Chevalier de Méré, was a gambler who also considered himself something of a mathematician. He computed the chance of a getting at least one six in four rolls as 2/3 $4 \times (1/6) = 4/6$. He won quite often by betting on this outcome.


What do you think is the chance of this? Start with one roll: what is the chance of landing 6 **at least once** in one roll? How about 4 rolls? How about 6 rolls?

We will see later how to compute this probability, but for now we can guess the value by simulating the game over and over and looking at the fraction of times we see at least one six in four rolls of a fair die. 
...
Here, we have thought about an event (the coin landing heads), seen that there is one outcome in that event, and two outcomes in the outcome space, so we say the probability of the event is 1/2. We can generalize this:



Equally likely outcomes
: When all the possible outcomes in an outcome space happen with the same probability.


Probability
: The chance or probability of a particular outcome is the fraction of times that this outcome is expected to occur, when the experiment that results in the outcome is repeated over and over again. This is called the long run relative frequency.
