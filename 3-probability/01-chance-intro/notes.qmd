...
We will see later how to compute this probability, but for now we can estimate the value by simulating the game 1000 times and looking at the proportion of times we see at least one six in 4 rolls of a fair die, and do the same with at least one double six in 24 rolls.
...
Before we write the third rule, we need some more definitions and some notation:
