...
Imagine you are rolling a six-sided die with a probability distribution given below. 

| $\textbf{roll}$  |  $\textbf{1}$  |  $\textbf{2}$ | $\textbf{3}$ | $\textbf{4}$| $\textbf{5}$ | $\textbf{6}$  |
| ---- | ----  | ---- | ---- | ---- | ---- | ---- | 
| $\textbf{P(roll)}$ | $\frac{1}{10}$  |  $\frac{3}{10}$    | $\frac{2}{10}$  |  $\frac{1}{10}$  | $\frac{2}{10}$  | $\frac{1}{10}$  |
