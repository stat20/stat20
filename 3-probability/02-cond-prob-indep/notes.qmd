...
For example, in the first example with the box with two red and two blue cards, if $A$ is the event of drawing a red card on the first draw, and $B$ is the event of drawing a blue card on the second draw, when we draw two cards *without* replacement, then 
