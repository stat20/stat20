...
[![](images/r2-thumbnail.png){width=400}](https://bcourses.berkeley.edu/courses/1521247/external_tools/78985)
...
Let's return to the data set that that we studying when we first leared about [Multiple Linear Regression](https://www.stat20.org/2-describing-data/10-multiple-linear-regression/notes.html): ratings of Italian restaurants from the Zagat guide. For each of the 168 restaurants in the data set, we have observations on the average price of a meal, the food quality, the quality of the decor, the quality of the service, and whether it is east or west of Fifth Avenue.
