...
If you have multiple problem set files on a single day, you can differentiate them using `ps1.qmd`, `ps2.qmd`, etc. For a reference, see the source for the [assignment page](https://github.com/stat20/stat20/blob/main/assignments.qmd) for the rule that determines which files show up in the listing.
