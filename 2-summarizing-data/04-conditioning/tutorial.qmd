...
This specific set of notes contains references to many functions from the `tidyverse` library such as `mutate()`, `select()`, `arrange()`, `summarize()`. We delve more into some of these functions here.
