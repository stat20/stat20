...
Color the points of the plot you made in **Question 7** by destination, and use this to provide a possible explanation for the relationship between the two variables in the plot title. You can add layers to plot objects with `+`.
