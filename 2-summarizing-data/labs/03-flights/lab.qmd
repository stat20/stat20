...
Color the points of the plot you made in **Question 7** by destination, and use this to provide a possible explanation for the relationship between the two variables (particularly, the noticeable gap) in the plot title. You can add layers to plot objects with `+`.
...
Explain which variables are better described via a linear model:

-   distance and average speed
-   log distance and log average speed 

in one-two sentences, using your results from **Question 7** and **Question 9** as support.
