...
To answer this worksheet, consult the printout of the original survey data found [here](glimpse-class-survey.qmd). You should also view the survey questions as they were asked to students [here](images/survey.pdf).
