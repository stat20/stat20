...
\begin{center}
\textsc{Stat 20: Lab 1.1 Class Survey} \\
...
3. What values would you expect `major` to take? Do you anticipate any challenges when analyzing this data (and why)?

\
\

4. Are there any other variables in the dataset which would present the same challenge you mentioned in Question 3? List them here.
...
5. Do students prefer to spend time at the beach or in the mountains?

{{< pagebreak >}}

6. Is there an association between students' favorite season and terrain preference (beach or mountains)?
...
7. How many students who preferred the mountains selected Winter as their favorite season?
