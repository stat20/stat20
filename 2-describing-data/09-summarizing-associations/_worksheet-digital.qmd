...
Repeat question 1 but use the horsepower of the car instead of the fuel efficiency. Compare the scatter plots: why does one of them have a higher correlation coefficient than the other?


#### Question 3

What is the better way to compare the strength of the linear relationship between these two pairs of variables: the correlation coefficient or the slope of a linear model? Why?
