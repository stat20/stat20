...
![](images/grayscale-8x8.png){fig-alt="8 by 8 grayscale image taken from the shoebill pixture." width="250" fig-align=center}
...
::: {.column width="33%"}
![](images/shoebill-1-grayscale.png)
:::

::: {.column width="33%"}
![](images/shoebill-2-grayscale.png)
:::

::: {.column width="34%"}
![](images/shoebill-3-grayscale.png)
:::
