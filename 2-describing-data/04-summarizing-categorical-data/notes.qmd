...
df <- data.frame(Biscoe = c(0.128, 0, 0.360, .488),
           Dream = c(0.163, 0.198, 0.000, 0.361),
           Torgersen = c(0.151, 0.000, 0.000, 0.151)) %>%
...
**Joint Proportion**
:    The proportion of observations of multiple variables that appear in a combination of levels of those variables. E.g. 44 / 344 = .128, the proportion of all 344 penguins that were Adelie and from Biscoe.

**Marginal Proportion**
:    The proportion of observations in one variable that appear in a single level of that variable. E.g. (44 + 124) / 344 = .488, the proportion of all penguins that were from Biscoe.

From these proportions we can derive a third type of proportion.

**Conditional Proportion**
:    The proportion of observations in one level of one variable that appear in a level of a second variable. E.g. .128 / .488 = .262, the proportion of penguins from Biscoe that were Adelie.
...
The first observation refers to a conditional proportion: of the 68 total Chinstrap penguins, 68 of them were on Dream (a proportion of 1). The second refers to a marginal proportion: .422 of the penguins were Adelie versus .198 Chinstrap and .360 Gentoo. The third is a joint proportion: .360, or 124 out of all 344 penguins were Gentoos living on Biscoe.
...
Now, the height of the blue bar in the lower left of the plot shows the proportion of penguins from Biscoe that were Gentoo: 124 / 168 = .738.
