...
[I]{.dropcap}n the last set of notes, we saw that there is a side to the discipline of Statistics that looks like engineering. Summary statistics - medians, standard deviations, etc. - are carefully crafted tools that capture different characteristics of a data set for use in very specific situations. There is another practice in statistics that looks more like a science; that is, a field that seeks to take many different phenomenona and explain them using a systematic overarching theory. That practice is data visualization.
...
In Lab 2 you created your very first plot, which looked like this.
...
You've seen another example of a plot that combines two geometries:
