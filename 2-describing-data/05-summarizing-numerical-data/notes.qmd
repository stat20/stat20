...
:::{.column-margin}
![](images/culmen-depth.png){width="250px"}
:::
...
There are many different ways to capture spread or dispersion of data. So many, in fact, that we'll save this part for a discussion during class time.
