...
- [Lab 6.1: Baseball](lab-context.pdf)
...
5. Fit a simple linear model to predict wins by runs and call it `model_1`. Write out the equation for the linear model (using the estimated coefficients) and report the $R^2$.
