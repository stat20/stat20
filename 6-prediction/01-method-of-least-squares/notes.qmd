...
While the Gradient Descent method is preferred over the Nelder-Mead method, we would like to show you the Nelder-Mead method in action. Here is a brief description of the method from Wikipedia, followed by a GIF which demonstrates the method being used to find a solution for an equation with two coefficients $b_1$ and $b_2$. 
...
#| fig-height: 1
#| fig-width: 1
knitr::include_graphics("images/Nelder-Mead_Himmelblau.gif")
```
