...
d. Construct a plot featuring 9 subplots, each one featuring a visualization of a data set generated under the null hypothesis. Does your visualization of the observed data from the previous part look like it be one of these plots? (Hint: Go up to the `generate()` step and then make the plot). 
