...
**Sampling variability**
:    If the sample is drawn from the population with some amount of randomness, the variability from one sample to the next.
