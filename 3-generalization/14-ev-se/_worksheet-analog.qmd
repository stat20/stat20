...
(ii) Consider $S_{200}$, the sum of $200$ random variables $X_1, X_2, \ldots, X_{200}$ which are independent and have the same distribution as $X$. You will win a prize if $-30 \le S_{100} \le 30$.
...
A box of 100 tickets contains 45 red tickets, 50 blue tickets,
  ...
  random, \textit{without} replacement. 

(a) What is the expected number of red tickets in the sample?
(b) What is the variance of the number of red tickets in the sample?
