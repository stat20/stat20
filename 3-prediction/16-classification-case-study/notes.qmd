...
This shows that the most accurate predictions came from using $K = 11$, but that values of $K$ between 5 and 18 all did quite well. We can get a final sense of the predictive accuracy of our best model by taking a look at the proportion of predicted species in the test data set were correct.
