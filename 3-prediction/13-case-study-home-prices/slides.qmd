...
1. Simpsons paradox with bedrooms and square feet
2. Look at dummy variables - which city is which?
1. Which cities have the mansions?
2. make predictions for the presidents house
...
:::{.notes}
This is a tricky question for most students because they expect that since bed and logsqft both have positive relationships with the response in a simple linear regression model, that they should still have a postive relationship in the multivariate setting. That's not the case.
...
1. Simpsons paradox with bedrooms and square feet
2. Look at dummy variables - which city is which?
3. causal interpretation of a coefficient

# practice computing

1. Which cities have the mansions?
2. make predictions for the presidents house
3. make a prediction for a small house with 10 bathrooms
