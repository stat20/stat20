...
What makes this study special is the process that generated this data.  
Because this was a randomized control experiment, we can make stronger claims here.
In particular, the difference in proportions provides a good estimate of the 
...
statistic:
$$
F_{balance} =\frac{\frac{1}{k}\sum^n_{i=1}(\widehat{z}_i - \overline{z})^2}{\frac{1}{n-k-1}\sum^n_{i=1}(z_i - \widehat{z}_i)^2}
$$
