...
`MatchIt` package supports many of them and provides a handy online
...
everyone in `grad_job`, we start with the output object from the matching
step and pipe it to the `match.data` command to obtain the smaller 
dataframe.
