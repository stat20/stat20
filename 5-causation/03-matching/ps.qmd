...
@. To what degree does this scenario have the characteristics of a natural experiment? Explain your reasoning.
...
@. Compute and report the associated effect estimate for
...
@. Conduct a hypothesis test to decide whether the effect estimate in the previous question differs significantly from zero.
