...
@. Pick one of the designs that is
not a good description of the actual data collection and describe how a hypothetical
study of minimum wage and fast food employment could be conducted using this 
strategy instead (expensive/impractical hypothetical designs are acceptable).
...
@. Create a Love plot in R and compare it to your answer from the previous question.  Pick 
...
@. Based on your answer to question 2, compute the associated effect estimate for
