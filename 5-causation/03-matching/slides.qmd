...
:::poll
How many of each type will remain after we conduct optimal matching on `metro` and `smoking_ban`?
...
Which of the following R commands correctly performs matching on covariates to measure the impact of `median_edu` on `homeownership`?
