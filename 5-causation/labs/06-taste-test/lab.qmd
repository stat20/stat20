...
it was collected, and print it out into your lab report. You can print all rows your data frame using `slice(my_df, 1:100)`. Consult the notes "A Tool for Computing with Data" for a refresher of how to make a data frame.
