...
In one sentence, write the causal question you intend to test. It should be composed of a *response* variable having to do with perception of bubble water and whether it is effected by a given intervention / *explanatory* variable.
