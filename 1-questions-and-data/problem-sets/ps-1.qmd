...
<!-- This is a problem set in three parts, each of which is submitted separately to Gradescope. Parts 2 and 3 are part of class and will  -->

### PS 1.1: Course Surveys (Due 8/29 9 am)
...
<!-- [Link to paper worksheet](../02-taxonomy-of-data/worksheet-analog.pdf). Please write answers by hand on the worksheet (or via tablet) and scan to a pdf for submission. Please use a pdf scanning app instead of just taking a photo (these ones are very hard for us to read and grade). -->
