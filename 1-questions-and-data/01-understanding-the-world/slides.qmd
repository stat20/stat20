...
:::{.poll}
Does this image change which claims are more or less likely? Up and down vote explanations at [pollev.com](https://pollev.com).
:::
...
> Practice by asking/answering a question on the "Syllabus Discussion" threaad on Ed via the link at the top right of <https://www.stat20.org>.
:::
...
- Leave a comment or ask a question the "Taxonomy of Data" thread on Ed.
