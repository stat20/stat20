...
Using data from a class survey, the average height of students in Stat 20 is 5'6. 

Using data from a class survey, 90% of students in Stat 20 want to learn programming.
...
*Example*\
Based on our Stat20 survey data, we believe the average height of Cal students is 5'6. 

Based on our Stat20 survey data, we believe that 90% of Cal students want to learn programming. 


*Hallmark of generalization claim*\
You can identify two sets of observations; one set you have (e.g. data from Stat20 students) and one set you wish you had (e.g. data from all call students).


:::{.notes}
We expect the first example to generalize, but not the second example.
:::
...
*Example*\
Based on reading the news and the price of Uber's stock today, I predict that Uber's stock price will go up 1.3% tomorrow.
