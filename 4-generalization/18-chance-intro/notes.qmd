...
and target population to exactly coincide. We need to make sure our target population and our access frame align as much possible. Then we need to design our data collection methods so that our sample is representative of the population, in order to generalize from the sample to the population. This is achieved using methods that incorporate chance.
...
### Drawing with replacement and without
