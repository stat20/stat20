---
title: "An Introduction to Chance"
...
<details><summary>Check your answer</summary>
The box will have six tickets as shown below, and we would draw one ticket from this box.
...
#### Example 6: Selecting an apple from a bag of fruit
 Suppose I have three apples and two mangoes in a bag. I shuffle the fruit in the bag and then pick one out. How would you represent this as a box model? What about if I only want an apple?
...
What is the chance that Alex and Max will be selected? Guess! (Hint: you have seen all the possible pairs above, and they are equally likely. What will be the chance of any one of them?)
