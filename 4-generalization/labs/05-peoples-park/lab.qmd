...
Create a 95% confidence interval for the overall proportion of students who support the People's Park Project without having been exposed to the information on page 14 using the normal curve. Interpret the interval in the context of the problem in a clear sentence. Does your point estimate approximately match that reported in the Chancellor's email?
