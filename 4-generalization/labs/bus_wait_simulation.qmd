...
10. What does the simulated distribution of wait times look like? Compare the distribution of `pass_wait` to the distribution of wait times from the first part of this lab, called `wait`. Also, compare the distribution to that of the observed lateness of the buses, called `bus_late$minutes_late` .
