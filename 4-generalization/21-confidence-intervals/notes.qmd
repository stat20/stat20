...
Suppose you take a simple random sample of 100 restaurants. That is, you draw 100 times without replacement from the population (box). Your sample is:
...
samp_scores
```
+ The *sample distribution* aka the empirical distribution appears below.
...
+ The sampling distribution SD, which is called the *Standard Error* is `r round(sd(samp_means), 1)`. This convention of calling the SD for a probability distribution of a statistic helps keep straight which kind of standard deviation we're talking about.   
...
For example, can you accompany your point estimate with a sense of its accuracy? Ideally, this would be the SE of the sample mean. Unfortunately, you don't know the SE because it depends on the populatio SD. So now what do you do?
