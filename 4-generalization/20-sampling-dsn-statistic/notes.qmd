...
```{r}
pew <- rep(c(1,2,3,4), times = c(22,41,24,13))
```

We can take a sample to look at the empirical distribution. Since the box represents the US population of women who have borne at least one child, we will sample with replacement.
