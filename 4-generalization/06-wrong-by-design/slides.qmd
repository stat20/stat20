...
The following two questions are based on the below diagram. The diagram corresponds to a one-sided hypothesis test that uses the following null hypothesis: $H_0: \mu = 1$.
