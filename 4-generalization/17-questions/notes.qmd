...
After we introduce inference, we will revisit the ask-a-question stage and demonstrate how to match the question with the type of data analysis to be carried out. 
...
We are interested in discovering factors that are related to flight delays.  
One approach is to describe our population of interest as all flights landing or taking off around the world. However, the data that we have available are all flights in to and out of San Francisco in 2020. If we think that flights in and out of San Francisco might be different in important ways from those in other locations (which makes sense, right?), then we must narrow the focus of the question to San Francisco flights.
...
In 2020, Johnson & Johnson carried out a clinical trial for their new COVID vaccine. They wanted to determine the efficacy of their vaccine, i.e., how much more were people with the vaccine able to  resist infection from COVID-19 compared to those who did not recieve any vaccine. 
