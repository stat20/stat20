...
[^1]: Adapted from *Introduction to Modern Statistics*, First Edition by Mine Çetinkaya-Rundel and Johanna Hardin, a textbook from the [OpenIntro Project](https://www.openintro.org/).
