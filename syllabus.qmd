...
We will use bCourses to disseminate announcements for the entire class, such as exact dates for your final exam. 
...
The final exam will be held in person during finals week. The current time and date is to be determined.  
...
If you ever need someone to talk to about anything that you're going through on campus, please feel to reach out to the instructors. For some topics, the tutors might be an even better resource because they are students just like you. Tutors can also tell you what being an Academic Student Employee (ASE) is like. 
