...
Tutors will offer group tutoring sessions several times each week. This is an opportunity to finish up any assignments that you've started in class or review any topics that are confusing for you. Each group tutoring session will be staffed by 2-4 tutors. You're welcome to attend any session that works well for your schedule. Check the [Office Hours](office-hours.qmd) page to see the group tutoring schedule.
...
tldr: if you dont get your work in by the deadline, don't fret. Fill out this form to request an extension on the deadline. We will be approving all requests that for extensions of three days and less past the assignment deadline.

spirit: deadlines are helpful to stay on track but we understand we're all busy and life happens. no worries, just ask for an extension.
