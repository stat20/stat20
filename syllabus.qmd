...
**It is your responsibility to become familiar with the topics that appear in the course notes and to work through the reading questions on Gradescope by 11:59 pm Monday (for Tues/Weds class) and 11:19 Wednesday (for Thurs/Fri class)**. You're encouraged to experiment to find the method that works best for you: downloading the notes as a pdf and making notes on them, asking and answering questions over the class forum, etc.

<<<<<<< HEAD
#### During class on Tuesday and Thursday (Wednesday and Friday)

Class time (2 hrs) will be spent on a range of activities, but the most common will be concept questions (using Poll Everywhere) and working through components of your Problem Sets and Labs. Therefore, the most efficient way to complete your assignments is to be an active participant in class. Attendance is expected on Tuesday and Thursday (Wednesday and Friday).
=======
...
>>>>>>> bb6ce0a4f64eec3772a33bb4045f933475fce36a
...
While in general this course does not have full lectures, there are a few select exceptions. Several times during the semester, the course will be hosting a special guest to give a lecture to all sections of Stat 20. These speakers will all be preeminent scientists and data scientists working in academia and industry and will speak on how the ideas and tools and the we discuss in class look in the real world.

The schedule of plenary lectures will be posted to the course schedule as soon as it is finalized. Lectures will held in the evening. There is an assignment associated with plenary lectures. If you cannot make the Stat 20 plenary lectures, you are welcome to go to attend other official statistics / data science seminars on campus.
...
#### Office Hours / Group Tutoring Sessions

<<<<<<< HEAD
The instructors and tutors will offer office hours / group tutoring sessions each week across a range of times. We ask that you visit the office hours of the instructor of your lab section but you're welcome to visit the office hours of any tutor, not only the one who works in your section. We may adjust the office hour schedule throughout the semester as we understand student needs and preferences.

Take advantage of this opportunity! Doing so does not send a signal that you are behind or need extra help. On the contrary, visiting course staff early and often tends to co-occur with success in the course.

Feel free to come visit us even if you don’t have a specific question about an assignment. The course staff is happy to chat about the course material, statistics in general, careers in statistics, or whatever other statistics or data science topics are on your mind!
=======
Office hours are an opportunity to chat one-on-one with your instructor. Please come to office hours! Coming to office hours does not send a signal that you are behind or need extra help. On the contrary, coming to office hours early and often tends to co-occur with success in the course. Instructors are happy to chat about the course material, statistics in general, careers in statistics, or whatever other statistics or data science topics are on your mind!
>>>>>>> bb6ce0a4f64eec3772a33bb4045f933475fce36a
...
Reading questions serve to check your understanding and engagement while going through the lecture notes prior to class. There will be a handful of questions per “lecture” and can be a mix of multiple choice, short answer, and coding questions. You can answer them directly on Gradescope. Note that the reading questions will be due 11:59 pm the night before class, that is, on 11:59 pm Monday for the Tue/Wed lecture, and 11:59 pm Wednesday for the Thu/Fri lecture.

#### Plenary Lecture Reviews

An important way to engage with new ideas and people at a University is to attend a guest lecture. A plenary lecture review is a written assignment that details the background of the speaker, the question they address, the tools, data, and methods they use, and their key findings.

You will be writing up few reviews of plenary lectures that you attend over the course of the semester. 
...
The final exam will be held in person during finals week. Your current final time is dependent on your section and so is available on CalCentral. 
...
1. What should I do if I'm on the waitlist?
   ...
   Attend lecture and section (remember, we are teaching it as *one* two hour class), and submit all assignments on time. Visit your instructor on the first day of class so you can be added to the course Ed and Gradescope.
