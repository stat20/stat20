...
<!-- We can visualize the distinction between the two groups in a small example with three people in the treatment group (pdf, in yellow) and three people in the control group (website, in blue). -->
