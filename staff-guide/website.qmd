...
1. Create a fork of <https://github.com/stat20/stat20> into your personal GitHub account.
2. On your machine, a new RStudio project from version control, linked to your fork of the Stat 20 repo.
3. Be sure you've [configured git](https://happygitwithr.com/hello-git) on your machine (allowing you to make commits) and [stored a Personal Access Token](https://happygitwithr.com/https-pat) (PAT) (allowing your machine to push commits to your repo on GitHub).

### Workflow

1. Go your the GitHub page to be sure your fork is synced with `stat20/stat20`.
2. In RStudio on `main`, pull any new changes.
3. Create a new branch named with what you're adding (e.g. `update-lab-6`).
